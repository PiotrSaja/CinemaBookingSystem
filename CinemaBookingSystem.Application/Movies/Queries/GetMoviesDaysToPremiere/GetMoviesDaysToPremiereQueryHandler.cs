...
{
    public class GetMoviesDaysToPremiereQueryHandler : IRequestHandler<GetMoviesDaysToPremiereQuery, MoviesDetailVm>
    {
        private readonly ICinemaDbContext _context;
        private readonly IMapper _mapper;
        private readonly IDateTime _dateTime;

        public GetMoviesDaysToPremiereQueryHandler(ICinemaDbContext context, IMapper mapper, IDateTime dateTime)
        {
            _context = context;
            _mapper = mapper;
            _dateTime = dateTime;
