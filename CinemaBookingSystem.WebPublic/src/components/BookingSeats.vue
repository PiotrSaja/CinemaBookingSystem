        ...
        <table class="mx-auto">
            ...
            <tr v-for='index in 3' :key='index'>
              <th class="pt-3 pr-5 font-weight-normal">Row: {{index}}</th>
                ...
                :key="seat.id" v-if='seat.cinemaSeat.row === index' class="pt-3" style="width: 50px">
                  <svg style="width:36px;height:36px; cursor: pointer" viewBox="0 0 24 24" v-if='seat.cinemaSeat.seatType === 1 && seat.seatStatus === false'>
                  ...
                  <svg style="width:36px;height:36px" viewBox="0 0 24 24" v-else-if='seat.cinemaSeat.seatType === 1 && seat.seatStatus === true'>
                  ...
                  <svg style="width:36px;height:36px" viewBox="0 0 24 24" v-else-if='seat.seatStatus === true'>
                  ...
                  <svg style="width:36px;height:36px;cursor: pointer" viewBox="0 0 24 24" v-else>
