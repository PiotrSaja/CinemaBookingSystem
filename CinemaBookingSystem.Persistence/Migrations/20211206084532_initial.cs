        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ActorName_FirstName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ActorName_LastName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeanceType = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PersonalName_FirstName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PersonalName_LastName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeanceSeats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SeanceSeats_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SeanceSeats_CinemaSeats_CinemaSeatId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeanceSeats_BookingId",
                table: "SeanceSeats",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_SeanceSeats_CinemaSeatId",
                table: "SeanceSeats",
                column: "CinemaSeatId");
