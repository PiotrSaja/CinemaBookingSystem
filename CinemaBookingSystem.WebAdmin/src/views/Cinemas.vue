      ...
      <div class="row p-2">
        <div>
          <DataTable
            ...
            dataKey="id"
            :rowHover="true"
            v-model:selection="selectedCinemas"
            ...
            :globalFilterFields="['name', 'city', 'street']"
          ...
          >
            ...
            <template #empty> No cinemas found. </template>
            <template #loading> Loading cinemas data. Please wait. </template>
            <Column
              field="name"
              header="Name"
              sortable
            ...
            >
              <template #body="{ data }">
                <Button
                  type="button"
                  icon="pi pi-pencil"
                  @click="showCinemaDetail(data.id)"
                ></Button>
              </template>
            </Column>
          </DataTable>
