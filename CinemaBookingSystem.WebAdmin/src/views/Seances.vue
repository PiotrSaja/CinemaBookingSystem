      ...
      <div class="row p-2">
        <div>
          <DataTable
            ...
            dataKey="id"
            :rowHover="true"
            v-model:selection="selectedSeances"
          ...
          >
            ...
            <template #empty> No seances found. </template>
            <template #loading> Loading seances data. Please wait. </template>
            <Column
              field="title"
              header="Title"
              sortable
            ...
            >
              ...
              <template #filter="{ filterModel }">
                <InputText
                  ...
                  v-model="filterModel.value"
                  class="p-column-filter"
                  placeholder="Search by cinema hall"
                />
              </template>
            </Column>
            <Column
            ...
            >
              <template #body="{ data }">
                <Button
                  type="button"
                  icon="pi pi-pencil"
                  @click="showSeanceDetail(data.id)"
                ></Button>
              </template>
            </Column>
          </DataTable>
...
export default {
  ...
  created() {
    SeanceService.getAll(1, 1000000)
      .then((response) => {
