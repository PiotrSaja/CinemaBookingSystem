<template>
  <section class="layout">
    ...
    <div class="body">
      ...
      <div class="row p-2">
        <card class="mt-3">
          <template #title> Update cinema hall </template>
          <template #content>
            <div class="ml-2">
                  ...
                  <div class="col-12 md:col-10">
                    <input
                      ...
                      class="
                        ...
                        w-full
                      "
                      v-model="cinemaHall.numberOfRows"
                    />
                  </div>
                </div>
                <div class="field grid">
                  ...
                  <div class="col-12 md:col-10">
                    <input
                      ...
                      class="
                        ...
                        w-full
                      "
                      v-model="cinemaHall.numberOfColumns"
                    />
                  </div>
                </div>
              </div>
                ...
                >
                  ...
                  <template #footer>
                    ...
                    <Button
                      label="Yes"
                      icon="pi pi-check"
                      @click="deleteCinemaHall(cinemaHall.id)"
                      class="p-button-text"
                      autofocus
                    />
                  </template>
...
export default {
  ...
  methods: {
    ...
    createCinemaHall() {
      this.cinemaHall.totalSeats =
        this.cinemaHall.numberOfRows * this.cinemaHall.numberOfColumns;

      CinemaHallService.create(this.cinemaHall)
        .then((response) => {
          console.log(response.data);
          this.$router.replace({
            name: "CinemaHalls",
    ...
    updateCinemaHall() {
      ...
      this.cinemaHallForm.totalSeats =
        this.cinemaHall.numberOfRows * this.cinemaHall.numberOfColumns;
      ...
      CinemaHallService.update(this.cinemaHallForm.id, this.cinemaHallForm)
        .then((response) => {
          console.log(response.data);
          this.$router.replace({
            name: "CinemaHalls",
