    ...
    <div class="body">
      ...
      <div class="row p-2">
        <div>
          ...
          <Button
            label="Add new hall"
            class="p-button-success p-button-rounded mt-3"
            @click="addNewHall()"
          />
          <DataTable
            :value="cinemaHalls"
            :paginator="true"
            class="p-datatable-customers mt-3"
            :rows="10"
            dataKey="id"
            :rowHover="true"
            v-model:selection="selectedCinemaHalls"
          ...
          >
            ...
            <template #empty> No cinema halls found. </template>
            <template #loading>
            ...
            >
              <template #body="{ data }">
                <Button
                  type="button"
                  icon="pi pi-users"
                  @click="showCinemaHallSeats(data.id)"
                  v-if="!data.isSeatsCreated"
                ></Button>
              </template>
            </Column>
            <Column
            ...
            >
              <template #body="{ data }">
                <Button
                  type="button"
                  icon="pi pi-pencil"
                  @click="showCinemaHallDetail(data.id)"
                ></Button>
              </template>
            </Column>
          </DataTable>
...
export default {
  ...
  created() {
    ...
    CinemaHallService.getInCinema(this.cinemaId)
      .then((response) => {
  ...
  methods: {
    ...
    showCinemaHallDetail(cinemaHallId) {
      this.$router.push({
        name: "CinemaHall",
        params: { cinemaId: this.cinemaId, id: cinemaHallId },
      });
    },
    showCinemaHallSeats(cinemaHallId) {
      this.$router.push({
        name: "NewCinemaSeats",
        params: { cinemaHallId: cinemaHallId },
      });
    },
    addNewHall() {
      this.$router.push({
